...
MapGroup_Cerulean:
	...
	map CeruleanCave1F, TILESET_CAVE, INDOOR, CERULEAN_CITY, MUSIC_DRAGONS_DEN, FALSE, PALLETE_DAY, FISHGROUP_NONE
	map CeruleanCave2F, TILESET_CAVE, INDOOR, CERULEAN_CITY, MUSIC_DRAGONS_DEN, FALSE, PALLETE_DAY, FISHGROUP_NONE
