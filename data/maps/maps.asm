...
MapGroup_Cinnabar:
	...
	map SeafoamCave, TILESET_ICE_PATH, INDOOR, SEAFOAM_CAVE, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cerulean:
	...
	map CeruleanCave1F, TILESET_CAVE, INDOOR, CERULEAN_CAVE, MUSIC_DRAGONS_DEN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CeruleanCave2F, TILESET_CAVE, INDOOR, CERULEAN_CAVE, MUSIC_DRAGONS_DEN, FALSE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Saffron:
	...
	map ColumboHouse, TILESET_PLAYERS_HOUSE, INDOOR, SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Ryokan:
	map RyokanOutside, TILESET_JOHTO, ROUTE, CIANWOOD_CITY, MUSIC_DANCING_HALL, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Ryokan1F, TILESET_TRADITIONAL_HOUSE, INDOOR, RYOKAN, MUSIC_DANCING_HALL, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Ryokan2F, TILESET_TRADITIONAL_HOUSE, INDOOR, RYOKAN, MUSIC_DANCING_HALL, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Ryokan3F, TILESET_TRADITIONAL_HOUSE, INDOOR, RYOKAN, MUSIC_DANCING_HALL, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RyokanRooms, TILESET_TRADITIONAL_HOUSE, INDOOR, RYOKAN, MUSIC_DANCING_HALL, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RyokanOnsen, TILESET_JOHTO, INDOOR, RYOKAN, MUSIC_DANCING_HALL, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map RyokanElevator, TILESET_POKECENTER, INDOOR, RYOKAN, MUSIC_DANCING_HALL, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RyokanDiningHall, TILESET_TRADITIONAL_HOUSE, INDOOR, RYOKAN, MUSIC_DANCING_HALL, TRUE, PALETTE_DAY, FISHGROUP_SHORE
