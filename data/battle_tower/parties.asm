...
BattleTowerMons7:
	...
	db GIRAFARIG
	db GOLD_BERRY
	db AGILITY, BATON_PASS, PSYCHIC, EARTHQUAKE
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons9:
	...
	db HYPNO
	db LEFTOVERS
	db REFLECT, PSYCHIC, THUNDER_WAVE, ICE_PUNCH
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons10:
	...
	db CELEBI
	db LEFTOVERS
	db LEECH_SEED, PSYCHIC, GIGA_DRAIN, TOXIC
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 58500
	...
	db GENGAR
	db FOCUS_BAND
	db EXPLOSION, THUNDERBOLT, PSYCHIC, NIGHTMARE
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 58500
