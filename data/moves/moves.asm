...
; entries correspond to constants/move_constants.asm
	...
	move COMET_PUNCH,  EFFECT_MULTI_HIT_FLINCH,   20, NORMAL,   PHYSICAL,  85, 15,  14
	...
	move RAZOR_WIND,   EFFECT_RAZOR_WIND,        100, NORMAL,   SPECIAL,   75, 10,   0
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, NORMAL,   STATUS,   100, 30,   0
	move CUT,          EFFECT_NORMAL_HIT,         50, NORMAL,   PHYSICAL,  95, 30,   0
	move GUST,         EFFECT_GUST,               60, FLYING,   SPECIAL,  100, 35,   0
	move WING_ATTACK,  EFFECT_NORMAL_HIT,         65, FLYING,   PHYSICAL, 100, 35,   0
	...
	move VINE_WHIP,    EFFECT_NORMAL_HIT,         60, GRASS,    PHYSICAL, 100, 10,   0
	move STOMP,        EFFECT_STOMP,              75, NORMAL,   PHYSICAL, 100, 20,  30
	...
	move BRICK_BREAK,  EFFECT_BRICK_BREAK,        70, FIGHTING, PHYSICAL, 100, 15,   0
	...
	move FURY_ATTACK,  EFFECT_MULTI_HIT,          18, NORMAL,   PHYSICAL,  85, 20,   0
	...
	move PIN_MISSILE,  EFFECT_MULTI_HIT,          20, BUG,      PHYSICAL,  85, 20,   0
	...
	move BUBBLEBEAM,   EFFECT_SPEED_DOWN_HIT,     75, WATER,    SPECIAL,  100, 20,  30
	move AURORA_BEAM,  EFFECT_ATTACK_DOWN_HIT,    75, ICE,      SPECIAL,  100, 20,  30
	move HYPER_BEAM,   EFFECT_HYPER_BEAM,        135, NORMAL,   PHYSICAL,  90,  5,   0
	move PECK,         EFFECT_NORMAL_HIT,         35, FLYING,   PHYSICAL, 100, 35,   0
	move DRILL_PECK,   EFFECT_NORMAL_HIT,         80, FLYING,   PHYSICAL, 100, 20,   0
	move SUBMISSION,   EFFECT_RECOIL_HIT,         85, FIGHTING, PHYSICAL,  90, 25,   0
	...
	move PETAL_DANCE,  EFFECT_RAMPAGE,           100, GRASS,    SPECIAL,  100, 20,   0
	move STRING_SHOT,  EFFECT_SPEED_DOWN,          0, BUG,      STATUS,    95, 40,   0
	move DRAGON_RAGE,  EFFECT_BURN_HIT,          100, DRAGON,   SPECIAL,   50, 10, 100
	move FIRE_SPIN,    EFFECT_TRAP_TARGET,        20, FIRE,     SPECIAL,   70, 15,   0
	...
	move SCREECH,      EFFECT_DEFENSE_DOWN_2,      0, NORMAL,   STATUS,    90, 40,   0
	...
	move POWER_GEM,    EFFECT_NORMAL_HIT,         70, ROCK,     SPECIAL,  100, 20,   0
	move SLUDGE,       EFFECT_POISON_HIT,         65, POISON,   PHYSICAL, 100, 20,  30
	...
	move SWIFT,        EFFECT_ALWAYS_HIT,         60, NORMAL,   PHYSICAL, 100, 20,   0
	move SKULL_BASH,   EFFECT_SKULL_BASH,        120, NORMAL,   PHYSICAL, 100, 15,   0
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          25, NORMAL,   PHYSICAL, 100, 15,   0
	...
	move KINESIS,      EFFECT_ACCURACY_DOWN_HIT,  40, PSYCHIC,  SPECIAL,   90, 15, 100
	...
	move EARTH_POWER,  EFFECT_SP_DEF_DOWN_HIT,    75, GROUND,   SPECIAL,  100, 10,  10
	move BARRAGE,      EFFECT_MULTI_HIT,          20, NORMAL,   PHYSICAL,  85, 20,   0
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          65, BUG,      PHYSICAL, 100, 15,   0
	...
	move NIGHTMARE,    EFFECT_NIGHTMARE,          50, GHOST,    SPECIAL,  100, 15,   0
	...
	move ZEN_HEADBUTT, EFFECT_FLINCH_HIT,         80, PSYCHIC,  PHYSICAL,  90, 15,  25
	...
	move FAINT_ATTACK, EFFECT_ALWAYS_HIT,         75, DARK,     SPECIAL,  100, 20,   0
	...
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  30, GROUND,   PHYSICAL, 100, 10, 100
	...
	move SPARK,        EFFECT_PARALYZE_HIT,       70, ELECTRIC, SPECIAL,  100, 20,  30
	move FURY_CUTTER,  EFFECT_FURY_CUTTER,        20, BUG,      PHYSICAL,  95, 20,   0
	move STEEL_WING,   EFFECT_DEFENSE_UP_HIT,     75, STEEL,    PHYSICAL, 100, 25,  10
	...
	move FRUSTRATION,  EFFECT_FRUSTRATION,        60, NORMAL,   PHYSICAL, 100, 20,   0
	...
	move DRAGONBREATH, EFFECT_PARALYZE_HIT,       65, DRAGON,   SPECIAL,  100, 20,  30
	move BATON_PASS,   EFFECT_BATON_PASS,          0, NORMAL,   STATUS,   100, 40,   0
	move ENCORE,       EFFECT_ENCORE,              0, NORMAL,   STATUS,   100,  5,   0
	move PURSUIT,      EFFECT_PURSUIT,            30, DARK,     PHYSICAL, 100, 20,   0
	...
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,    PHYSICAL,  85, 15,  30
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      75, STEEL,    PHYSICAL, 100, 35,  10
	...
	move HIDDEN_POWER, EFFECT_HIDDEN_POWER,       69, NORMAL,   PHYSICAL, 100, 15,   0
	...
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT,         65, ROCK,     PHYSICAL, 100,  5,  12
	move SHADOW_BALL,  EFFECT_DEFENSE_DOWN_HIT,   80, GHOST,    PHYSICAL, 100, 15,  20
	...
	move FOCUS_BLAST,  EFFECT_NORMAL_HIT,         75, FIGHTING, SPECIAL,   90, 10,  10
	move POWER_TRICK,  EFFECT_POWER_TRICK,         0, PSYCHIC,  STATUS,   100, 10, 100
