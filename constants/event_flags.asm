...
; Juggler
	...
	const EVENT_BEAT_JUGGLER_ZANDREW
; Gentleman
...
; PKMNTrainer
	const EVENT_BEAT_PKMNTRAINER_CAL1DUMMY
	const EVENT_BEAT_PKMNTRAINER_CAL2DUMMY
	const EVENT_BEAT_PKMNTRAINER_CAL3DUMMY
	const EVENT_BEAT_PKMNTRAINER_NOLAN
	const EVENT_BEAT_PKMNTRAINER_DYLAN
	const EVENT_BEAT_PKMNTRAINER_PETER
; PokefanM
...
; Pokemaniac
	...
	const EVENT_BEAT_POKEMANIAC_FARNSWO
; GruntM
...
; CooltrainerM
	...
	const EVENT_BEAT_COOLTRAINERM_BANMAN
; CooltrainerF
...
; Johto people
	...
	const EVENT_VICTORY_ROAD_MOLTRES_MOLTRES
	const EVENT_RED_SPECIAL_BALL
	const EVENT_POWER_PLANT_ZAPDOS_ZAPDOS
	const EVENT_SEAFOAM_ISLAND_ARTICUNO_ARTICUNO
	const EVENT_MT_MOON_MEW_MEW
	const EVENT_CERULEAN_CAVE_MEWTWO_MEWTWO
...
; New to Crystal
	...
	const EVENT_RYOKAN_BLOCK
	const EVENT_BEAT_RYOKAN_ONSEN_TRAINER
	const EVENT_BEAT_RYOKAN_ROOM1_TRAINER
	const EVENT_BEAT_RYOKAN_ROOM2_TRAINER
	const EVENT_BEAT_RYOKAN_ROOM3_TRAINER
	const EVENT_BEAT_RYOKAN_BOSS
	const EVENT_ONSEN_HIDDEN_REVIVAL_HERB
	const EVENT_RYOKAN_HIDDEN_LIGHT_BALL
	const EVENT_LADY_LORELEI_IN_SEAFOAM_CAVE
	const EVENT_GIOVANNI_IN_CERULEAN_CAVE
	const EVENT_BEAT_LADY_LORELEI
	const EVENT_BEAT_CRONE_AGATHA
	const EVENT_BEAT_EXILE_GIOVANNI
	const EVENT_BEAT_DETECTIVE_COLUMBO
	const EVENT_GOT_SLOWPOKETAIL
	const EVENT_COLUMBO_ROUTE34_ILEX
	const EVENT_COLUMBO_IN_GOLDENROD
NUM_EVENTS EQU const_value ; 7d1
