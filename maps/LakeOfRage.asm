...
LakeOfRage_MapEvents:
	...
	object_event 17, 32, SPRITE_CLERK, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 1, TrainerPokemaniacFarnswo, EVENT_LAKE_OF_RAGE_CIVILIANS
